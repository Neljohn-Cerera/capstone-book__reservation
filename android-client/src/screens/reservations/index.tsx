...
import { useUserReservationsQuery } from "../../generated/graphql";
...
const ReservationsScreen: React.FC = () => {
  ...
  return (
    <View style={{ flex: 1 }}>
      <Text style={styles.title}>Reservations Records</Text>
          ...
          renderItem={({ item, index }) => (
            ...
            >
              ...
              <View>
                ...
                <Text style={{ fontSize: 10 }}>{item.book.accountNumber}</Text>
                <Text style={{ fontSize: 10 }}>
                  {new Date(item.reserveDate).toDateString()}
                </Text>
                <Text
                  style={[
                    {
                    ...
                    item.reservationStatus.status === "APPROVED"
                      ? { color: "blue" }
                      : { color: "red" },
                  ]}
                >
                ...
                item.expired === false ? (
                  ...
                  item.expired === true ? (
                  <Text style={{ fontSize: 14, color: "#C92E2E" }}>
                    Borrowed
                  </Text>
                ) : null}
              </View>
              <Text
                style={[
                  styles.status,
                  item.reservationStatus.status === "PENDING"
                    ? {
